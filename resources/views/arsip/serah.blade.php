    ...
    <div class="w-full p-4 sm:p-6 lg:p-8 pt-6" 
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="font-bold text-2xl text-slate-800 flex items-center gap-2">
                <span class="text-blue-500">🤝</span> Daftar Arsip Statis <span class="text-blue-600">Usul Serah</span>
            </h2>
        </div>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-5 py-3 text-center">
                                <span class="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs font-bold uppercase">
                                    {{ $arsip->nomor_boks ?: 'Serah' }}
                                </span>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-12 text-center text-slate-400">Belum ada arsip usul serah.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
                                ...
                                <div class="relative border-l-2 border-slate-200 ml-4 space-y-8">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="ml-10">
                                            ...
                                            <div class="mt-2 mb-2 inline-block px-3 py-1 rounded-full text-xs font-bold tracking-wider bg-indigo-100 text-indigo-700" 
                                                 x-text="(activeArsip.status || 'SERAH').toUpperCase()">
                                            </div>
