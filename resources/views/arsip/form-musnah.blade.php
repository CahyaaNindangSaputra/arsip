        ...
        <div class="bg-white w-full max-w-xl rounded-xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800 text-sm flex items-center gap-2">
                    🔥 Form Daftar Arsip Inaktif Usul Musnah
                </h3>
                <a href="{{ route('arsip.index') }}" class="text-gray-400 hover:text-gray-600 font-bold text-lg">&times;</a>
            </div>

            <div class="p-6">
                <div class="mb-4 p-3 bg-red-50/60 rounded-lg border border-red-100 text-xs space-y-1 text-red-900">
                    <p class="font-bold border-b border-red-200 pb-1 mb-1">Detail Arsip:</p>
                ...
                <form action="{{ route('arsip.proses_musnah', $arsip->id) }}" method="POST">
                    @csrf 
                    @method('PATCH')
                    ...
                    <div class="mb-4">
                        <label class="block text-xs font-bold text-gray-700 mb-1">Kurun Waktu (Contoh: 2020-2022)</label>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="keterangan_nasib_akhir" value="Musnah" class="w-full text-xs border-gray-300 rounded-md shadow-sm p-2.5 border bg-gray-50 font-bold text-red-600" readonly>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 pt-2 border-t border-gray-100">
                        ...
                        <button type="submit" style="background-color: #dc2626; color: #ffffff; padding: 8px 16px; border-radius: 8px; font-weight: 700; font-size: 12px; border: none; cursor: pointer;">
                            Proses Usul Musnah
                        </button>
                    </div>
                </form>
