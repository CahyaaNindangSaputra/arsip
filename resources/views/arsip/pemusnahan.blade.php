<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800">Daftar Arsip Inaktif Usul Musnah</h2></x-slot>
    <div class="py-12">
                ...
                <table class="w-full border-collapse border border-gray-800 text-xs text-center">
                    <thead class="bg-gray-400 font-bold">
                        <tr>
                            ...
                            <th class="border border-gray-800 p-2">Jenis/Seri Arsip</th>
                            ...
                            <th class="border border-gray-800 p-2">Keterangan Nasib akhir</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($arsipMusnah as $index => $arsip)
                        <tr>
                            <td class="border border-gray-800 p-2">{{ $index + 1 }}</td>
                            <td class="border border-gray-800 p-2 text-left">{{ $arsip->jenis_seri_arsip }}</td>
                            ...
                            <td class="border border-gray-800 p-2">Musnah</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
